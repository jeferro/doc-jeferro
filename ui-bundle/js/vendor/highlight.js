!function () {
    ...
    function n(e) {
        var n = {className: "variable", variants: [{begin: /\$[\w\d#@][\w\d_]*/}, {begin: /\$\{(.*?)}/}]}, a = {
            className: "string",
            begin: /"/,
            end: /"/,
        ...
        return {
            ...
            contains: [{className: "meta", begin: /^#![^\n]+sh\s*$/, relevance: 10}, {
                ...
                relevance: 0
            }, e.HASH_COMMENT_MODE, a, {className: "", begin: /\\"/}, {className: "string", begin: /'/, end: /'/}, n]
        }
    }

    function a(e) {
        var n = {begin: c = "[" + (c = "a-zA-Z_\\-!.?+*=<>&#'") + "][" + c + "0-9/;:]*", relevance: 0},
            a = {className: "number", begin: "[-+]?\\d+(\\.\\d+)?", relevance: 0},
            t = e.inherit(e.QUOTE_STRING_MODE, {illegal: null}), i = e.COMMENT(";", "$", {relevance: 0}),
            d = {className: "literal", begin: /\b(true|false|nil)\b/}, s = {begin: "[\\[\\{]", end: "[\\]\\}]"},
            g = {className: "comment", begin: "\\^" + c}, r = e.COMMENT("\\^\\{", "\\}"),
            u = {className: "symbol", begin: "[:]{1,2}" + c}, l = {begin: "\\(", end: "\\)"},
            o = {endsWithParent: !0, relevance: 0}, c = {
                ...
                begin: c,
                starts: o
            }, n = [l, t, g, r, i, u, s, a, d, n];
        return l.contains = [e.COMMENT("comment", ""), c, o], o.contains = n, s.contains = n, r.contains = [s], {
            aliases: ["clj"],
            illegal: /\S/,
            contains: [l, t, g, r, i, u, s, a, d]
        }
    }
    ...
    function t(e) {
        ...
        var a = "decltype\\(auto\\)", t = "[a-zA-Z_]\\w*::", i = {className: "keyword", begin: "\\b[a-z\\d_]*_t\\b"},
            s = {
                className: "string",
                variants: [{
                    begin: '(u8?|U|L)?"',
            ...
            }, d = {className: "title", begin: n(t) + e.IDENT_RE, relevance: 0}, t = n(t) + e.IDENT_RE + "\\s*\\(", o = {
            ...
            }, c = [i, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, r, s], g = {
                variants: [{begin: /=/, end: /;/}, {begin: /\(/, end: /\)/}, {
                    beginKeywords: "new throw return else",
                    end: /;/
                }],
                keywords: o,
                contains: c.concat([{begin: /\(/, end: /\)/, keywords: o, contains: c.concat(["self"]), relevance: 0}]),
                relevance: 0
            }, a = {
                className: "function",
                begin: "((decltype\\(auto\\)|(?:[a-zA-Z_]\\w*::)?[a-zA-Z_]\\w*(?:<.*?>)?)[\\*&\\s]+)+" + t,
                returnBegin: !0,
                end: /[{;=]/,
                excludeEnd: !0,
                keywords: o,
                illegal: /[^\w\s\*&:<>]/,
                contains: [{begin: a, keywords: o, relevance: 0}, {
                    begin: t,
                    returnBegin: !0,
                    contains: [d],
                    relevance: 0
                    ...
                    keywords: o,
                    relevance: 0,
                    contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, s, r, i, {
                        begin: /\(/,
                        end: /\)/,
                        keywords: o,
                        relevance: 0,
                        contains: ["self", e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, s, r, i]
                    }]
        ...
        return {
            ...
            exports: {preprocessor: l, strings: s, keywords: o}
        }
    }
    ...
    function i(e) {
        var n = {
            ...
            s = (s.contains = [o, l, t, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a, e.C_BLOCK_COMMENT_MODE], r.contains = [c, l, i, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a, e.inherit(e.C_BLOCK_COMMENT_MODE, {illegal: /\n/})], {variants: [o, l, t, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE]}),
            r = e.IDENT_RE + "(<" + e.IDENT_RE + "(\\s*,\\s*" + e.IDENT_RE + ")*>)?(\\[\\])?";
        return {
            aliases: ["csharp", "c#"],
            keywords: n,
            illegal: /::/,
    ...
    function g(e) {
        var n = "[a-zA-Z_][a-zA-Z0-9_.]*(\\!|\\?)?",
            ...
            t = {className: "subst", begin: "#\\{", end: "}", lexemes: n, keywords: a}, i = {
                className: "string",
                begin: "~[a-z](?=" + (s = "[/|([{<\"']") + ")",
                contains: [{
                    endsParent: !0,
            ...
            }), s = [r, s, i, e.HASH_COMMENT_MODE, o, l, {begin: "::"}, {
                className: "symbol",
                begin: ":(?![\\s:])",
    ...
    function m(e) {
        var n = {variants: [e.COMMENT("--", "$"), e.COMMENT("{-", "-}", {contains: ["self"]})]},
            ...
            i = {className: "type", begin: "\\b[A-Z][\\w']*", relevance: 0}, s = {
                begin: "\\(",
                end: "\\)",
                illegal: '"',
                contains: [a, t, {
        ...
        return {
            ...
            contains: [{
                ...
                contains: [a, i, s, {begin: "{", end: "}", contains: s.contains}, n]
            ...
            }, a, t, e.QUOTE_STRING_MODE, e.C_NUMBER_MODE, i, e.inherit(e.TITLE_MODE, {begin: "^[_a-z][\\w']*"}), n, {begin: "->|<-"}]
        }
    }
    ...
    function b(e) {
        ...
        return {
            ...
            }, a, {className: "meta", begin: "@[A-Za-z]+"}]
        }
    }

    function p(e) {
        var d = "<>", g = "</>", n = /<[A-Za-z0-9\\._:-]+/, a = /\/[A-Za-z0-9\\._:-]+>|\/>/,
            t = "[A-Za-z$_][0-9A-Za-z$_]*", i = {
                ...
                relevance: 0
            }, r = {className: "subst", begin: "\\$\\{", end: "\\}", keywords: i, contains: []}, l = {
                begin: "html`",
                end: "",
                starts: {end: "`", returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, r], subLanguage: "xml"}
            }, o = {
                begin: "css`",
                end: "",
                starts: {end: "`", returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, r], subLanguage: "css"}
            }, c = {className: "string", begin: "`", end: "`", contains: [e.BACKSLASH_ESCAPE, r]},
            r = (r.contains = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, l, o, c, s, e.REGEXP_MODE], r.contains.concat([e.C_BLOCK_COMMENT_MODE, e.C_LINE_COMMENT_MODE]));
        return {
            ...
            contains: [{className: "meta", relevance: 10, begin: /^\s*['"]use (strict|asm)['"]/}, {
            ...
            }, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, l, o, c, e.C_LINE_COMMENT_MODE, e.COMMENT("/\\*\\*", "\\*/", {
                relevance: 0,
                contains: [{
                    className: "doctag",
                    begin: "@[A-Za-z]+",
                ...
                contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, e.REGEXP_MODE, {
                    ...
                    variants: [{begin: d, end: g}, {
                        begin: n,
                        end: a
                    }], subLanguage: "xml", contains: [{begin: n, end: a, skip: !0, contains: ["self"]}]
                }],
                relevance: 0
            }, {
                className: "function",
    ...
    function f(e) {
        var n = {literal: "true false null"}, a = [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE],
            t = [e.QUOTE_STRING_MODE, e.C_NUMBER_MODE],
            i = {end: ",", endsWithParent: !0, excludeEnd: !0, contains: t, keywords: n}, s = {
                begin: "{",
                end: "}",
                contains: [{
                    className: "attr",
                ...
                illegal: "\\S"
            }, e = {begin: "\\[", end: "\\]", contains: [e.inherit(i)], illegal: "\\S"};
        return t.push(s, e), a.forEach(function (e) {
            t.push(e)
    ...
    function E(e) {
        var n = {
            ...
            t = {className: "subst", begin: "\\${", end: "}", contains: [e.C_NUMBER_MODE]}, i = {
                className: "string",
                variants: [{
                    begin: '"""',
                    end: '"""(?=[^"])',
                    contains: [i = {className: "variable", begin: "\\$" + e.UNDERSCORE_IDENT_RE}, t]
                }, {begin: "'", end: "'", illegal: /\n/, contains: [e.BACKSLASH_ESCAPE]}, {
                    begin: '"',
                    end: '"',
                    illegal: /\n/,
            ...
            c = o;
        return c.variants[1].contains = [o], o.variants[1].contains = [c], {
            aliases: ["kt"],
            keywords: n,
            contains: [e.COMMENT("/\\*\\*", "\\*/", {
                relevance: 0,
                ...
                contains: [{
                    ...
                    contains: [{
                        ...
                        relevance: 0
                    }, e.C_LINE_COMMENT_MODE, l, t, s, i, e.C_NUMBER_MODE]
                }, l]
            }, {
                className: "class",
                ...
                contains: [{beginKeywords: "public protected internal private constructor"}, e.UNDERSCORE_TITLE_MODE, {
                    ...
                    excludeEnd: !0,
                    relevance: 0
                }, {className: "type", begin: /[,:]\s*/, end: /[<\(,]|$/, excludeBegin: !0, returnEnd: !0}, t, s]
            }, i, {className: "meta", begin: "^#!/usr/bin/env", end: "$", illegal: "\n"}, r]
        }
    }

    function N(e) {
        var n = "\\[=*\\[", a = "\\]=*\\]", t = {begin: n, end: a, contains: ["self"]},
            i = [e.COMMENT("--(?!" + n + ")", "$"), e.COMMENT("--" + n, a, {contains: [t], relevance: 10})];
        return {
    ...
    function v(e) {
        var n = {
            ...
            e = [e.NUMBER_MODE, e.HASH_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, {
                className: "string",
                contains: [a],
                variants: [{begin: "''", end: "''"}, {begin: '"', end: '"'}]
            }, {
    ...
    function O(e) {
        var n = "getpwent getservent quotemeta msgrcv scalar kill dbmclose undef lc ma syswrite tr send umask sysopen shmwrite vec qx utime local oct semctl localtime readpipe do return format read sprintf dbmopen pop getpgrp not getpwnam rewinddir qqfileno qw endprotoent wait sethostent bless s|0 opendir continue each sleep endgrent shutdown dump chomp connect getsockname die socketpair close flock exists index shmgetsub for endpwent redo lstat msgctl setpgrp abs exit select print ref gethostbyaddr unshift fcntl syscall goto getnetbyaddr join gmtime symlink semget splice x|0 getpeername recv log setsockopt cos last reverse gethostbyname getgrnam study formline endhostent times chop length gethostent getnetent pack getprotoent getservbyname rand mkdir pos chmod y|0 substr endnetent printf next open msgsnd readdir use unlink getsockopt getpriority rindex wantarray hex system getservbyport endservent int chr untie rmdir prototype tell listen fork shmread ucfirst setprotoent else sysseek link getgrgid shmctl waitpid unpack getnetbyname reset chdir grep split require caller lcfirst until warn while values shift telldir getpwuid my getprotobynumber delete and sort uc defined srand accept package seekdir getprotobyname semop our rename seek if q|0 chroot sysread setpwent no crypt getc chown sqrt write setnetent setpriority foreach tie sin msgget map stat getlogin unless elsif truncate exec keys glob tied closedirioctl socket readlink eval xor readline binmode setservent eof ord bind alarm pipe atan2 getgrent exp time push setgrent gt lt or ne m|0 break given say state when",
            a = {className: "subst", begin: "[$@]\\{", end: "\\}", keywords: n}, t = {begin: "->{", end: "}"}, i = {
                variants: [{begin: /\$\d/}, {begin: /[\$%@](\^\w\b|#\w+(::\w+)*|{\w+}|\w+(::\w*)*)/}, {
                    begin: /[\$%@][^\s\w{]/,
                    relevance: 0
                }]
            }, s = [e.BACKSLASH_ESCAPE, a, i],
            i = [i, e.HASH_COMMENT_MODE, e.COMMENT("^\\=\\w", "\\=cut", {endsWithParent: !0}), t, {
                className: "string",
                contains: s,
        ...
        return a.contains = i, {aliases: ["pl", "pm"], lexemes: /[\w\.]+/, keywords: n, contains: t.contains = i}
    }

    function M(e) {
        var n = {begin: "\\$+[a-zA-Z_-ÿ][a-zA-Z0-9_-ÿ]*"}, a = {className: "meta", begin: /<\?(php)?|\?>/}, t = {
            className: "string",
        ...
        return {
            ...
            contains: [e.HASH_COMMENT_MODE, e.COMMENT("//", "$", {contains: [a]}), e.COMMENT("/\\*", "\\*/", {
                ...
                illegal: /[\.']/,
                contains: [e.UNDERSCORE_TITLE_MODE]
            }, {beginKeywords: "use", end: ";", contains: [e.UNDERSCORE_TITLE_MODE]}, {begin: "=>"}, t, i]
        }
    }

    function x(e) {
        var n = "[ \\t\\f]*", a = "(" + n + "[:=]" + n + "|[ \\t\\f]+)", t = "([^\\\\\\W:= \\t\\f\\n]|\\\\.)+",
            i = "([^\\\\:= \\t\\f\\n]|\\\\.)+", s = {
                end: a,
                relevance: 0,
        ...
        return {
            ...
            contains: [e.COMMENT("^\\s*[!#]", "$"), {
                begin: t + a,
                returnBegin: !0,
                contains: [{className: "attr", begin: t, endsParent: !0, relevance: 0}],
                starts: s
            }, {
                begin: i + a,
                returnBegin: !0,
                relevance: 0,
                contains: [{className: "meta", begin: i, endsParent: !0, relevance: 0}],
                starts: s
    ...
    function C(e) {
        var n = e.COMMENT("#", "$"), a = "([A-Za-z_]|::)(\\w|::)*", t = e.inherit(e.TITLE_MODE, {begin: a}),
            a = {className: "variable", begin: "\\$" + a}, i = {
                className: "string",
                contains: [e.BACKSLASH_ESCAPE, a],
                variants: [{begin: /'/, end: /'/}, {begin: /"/, end: /"/}]
            };
    ...
    function S(e) {
        var n = {
            ...
            }, r = {className: "params", begin: /\(/, end: /\)/, contains: ["self", a, s, i, e.HASH_COMMENT_MODE]};
        return t.contains = [i, s, a], {
    ...
    function T(e) {
        var n = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?", a = {
                ...
                literal: "true false nil"
            }, t = {className: "doctag", begin: "@[A-Za-z]+"}, i = {begin: "#<", end: ">"},
            t = [e.COMMENT("#", "$", {contains: [t]}), e.COMMENT("^\\=begin", "^\\=end", {
                contains: [t],
                relevance: 10
            }), e.COMMENT("^__END__", "\\n$")], s = {className: "subst", begin: "#\\{", end: "}", keywords: a}, r = {
                className: "string",
                ...
                variants: [{begin: /'/, end: /'/}, {begin: /"/, end: /"/}, {begin: /`/, end: /`/}, {
                    ...
                    begin: /<<[-~]?'?(\w+)(?:.|\n)*?\n\s*\1\b/,
                    returnBegin: !0,
                    contains: [{begin: /<<[-~]?'?/}, {begin: /\w+/, endSameAsBegin: !0, contains: [e.BACKSLASH_ESCAPE, s]}]
                }]
            }, l = {className: "params", begin: "\\(", end: "\\)", endsParent: !0, keywords: a}, r = [r, i, {
                className: "class",
                ...
                begin: e.UNDERSCORE_IDENT_RE + "(\\!|\\?)?:",
                relevance: 0
            }, {className: "symbol", begin: ":(?!\\s)", contains: [r, {begin: n}], relevance: 0}, {
                className: "number",
                begin: "(\\b0[0-7_]+)|(\\b0x[0-9a-fA-F_]+)|(\\b[1-9][0-9_]*(\\.[0-9_]+)?)|[0_]\\b",
                relevance: 0
            }, {begin: "(\\$\\W)|((\\$|\\@\\@?)(\\w+))"}, {
        ...
        return s.contains = r, l.contains = r, {
            aliases: ["rb", "gemspec", "podspec", "thor", "irb"],
            keywords: a,
            illegal: /\/\*/,
            contains: t.concat([{begin: /^\s*=>/, starts: {end: "$", contains: r}}, {
                className: "meta",
    ...
    function A(e) {
        var n = {className: "subst", variants: [{begin: "\\$[A-Za-z0-9_]+"}, {begin: "\\${", end: "}"}]}, n = {
            className: "string",
            variants: [{begin: '"', end: '"', illegal: "\\n", contains: [e.BACKSLASH_ESCAPE]}, {
                begin: '"""',
                end: '"""',
        ...
        }, a = {className: "type", begin: "\\b[A-Z][A-Za-z0-9_]*", relevance: 0}, t = {
            className: "title",
            begin: /[^0-9\n\t "'(),.`{}\[\]:;][^\n\t "'(),.`{}\[\]:;]+|[^0-9\n\t "'(),.`{}\[\]:;=]/,
            relevance: 0
        };
    ...
    function L(e) {
        var n = {
            ...
            t = {className: "subst", begin: /\\\(/, end: "\\)", keywords: n, contains: []}, i = {
                className: "string",
                contains: [e.BACKSLASH_ESCAPE, t],
                variants: [{begin: /"""/, end: /"""/}, {begin: /"/, end: /"/}]
            }, s = {
        ...
        return t.contains = [s], {
            keywords: n,
            contains: [i, e.C_LINE_COMMENT_MODE, a, {
                className: "type",
                begin: "\\b[A-Z][\\wÀ-ʸ']*[!?]"
    ...
    function I(e) {
        var n = {className: "symbol", begin: "&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;"},
            ...
            s = e.inherit(e.QUOTE_STRING_MODE, {className: "meta-string"}), r = {
                endsWithParent: !0,
                illegal: /</,
                relevance: 0,
    ...
    function B(e) {
        var n = "true false yes no null", a = {
            className: "string",
            relevance: 0,
        ...
        return {
            ...
            contains: [{
                ...
                beginKeywords: n,
                keywords: {literal: n}
            }, {className: "number", begin: e.C_NUMBER_RE + "\\b"}, a]
        }
    }

    var l, o, c = {};
    l = function (t) {
        var a, g = [], s = Object.keys, w = Object.create(null), r = Object.create(null), O = !0,
            l = /^(no-?highlight|plain|text)$/i, o = /\blang(?:uage)?-([\w-]+)\b/i, c = /((^(<[^>]+>|\t|)+|(?:\n)))/gm,
            T = "</span>", k = "Could not find the language '{}', did you forget to load/include a language module?",
        ...
        function i(e) {
            var n, a = {}, t = Array.prototype.slice.call(arguments, 1);
            for (n in e) a[n] = e[n];
        ...
        function m(e) {
            ...
            return function e(n, a) {
                for (var t = n.firstChild; t; t = t.nextSibling) 3 === t.nodeType ? a += t.nodeValue.length : 1 === t.nodeType && (i.push({
                    event: "start",
                    offset: a,
                    node: t
                }), a = e(t, a), u(t).match(/br|hr|img|input/) || i.push({event: "stop", offset: a, node: t}));
                return a
            }(e, 0), i
        }
        ...
        function b(e, n, a) {
            ...
            for (; e.length || n.length;) {
                var c = r();
                if (i += x(a.substring(t, c[0].offset)), t = c[0].offset, c === e) {
                    for (s.reverse().forEach(o); d(c.splice(0, 1)[0]), (c = r()) === e && c.length && c[0].offset === t;) ;
                    s.reverse().forEach(l)
                } else "start" === c[0].event ? s.push(c[0].node) : s.pop(), d(c.splice(0, 1)[0])
            }
            return i + x(a.substr(t))
        }

        function p(n) {
            return n.variants && !n.cached_variants && (n.cached_variants = n.variants.map(function (e) {
                return i(n, {variants: null}, e)
        ...
        function f(e) {
            if (a && !e.langApiRestored) {
                ...
                (e.contains || []).concat(e.variants || []).forEach(f)
            }
        }

        function E(n, t) {
            var i = {};
            return "string" == typeof n ? a("keyword", n) : s(n).forEach(function (e) {
                a(e, n[e])
            }), i;
            ...
            function a(a, e) {
                (e = t ? e.toLowerCase() : e).split(" ").forEach(function (e) {
                    var n, e = e.split("|");
                    i[e[0]] = [a, (n = e[0], (e = e[1]) ? Number(e) : function (e) {
        ...
        function A(t) {
            ...
            function i(i) {
                ...
                return l.lastIndex = 0, l.exec = function (e) {
                    ...
                    var a = c.exec(e);
                    if (!a) return null;
                    for (var t = 0; t < a.length; t++) if (null != a[t] && null != s["" + t]) {
                        n = s["" + t];
                        break
                    }
            ...
            !function n(a, e) {
                a.compiled || (a.compiled = !0, a.keywords = a.keywords || a.beginKeywords, a.keywords && (a.keywords = E(a.keywords, t.case_insensitive)), a.lexemesRe = g(a.lexemes || /\w+/, !0), e && (a.beginKeywords && (a.begin = "\\b(" + a.beginKeywords.split(" ").join("|") + ")\\b"), a.begin || (a.begin = /\B|\b/), a.beginRe = g(a.begin), a.endSameAsBegin && (a.end = a.begin), a.end || a.endsWithParent || (a.end = /\B|\b/), a.end && (a.endRe = g(a.end)), a.terminator_end = d(a.end) || "", a.endsWithParent && e.terminator_end && (a.terminator_end += (a.end ? "|" : "") + e.terminator_end)), a.illegal && (a.illegalRe = g(a.illegal)), null == a.relevance && (a.relevance = 1), a.contains || (a.contains = []), a.contains = Array.prototype.concat.apply([], a.contains.map(function (e) {
                    return p("self" === e ? a : e)
        ...
        function C(n, a, g, u) {
            ...
            function s(e, n, a, t) {
                if (!a && "" === n) return "";
                if (!e) return n;
                t = '<span class="' + (t ? "" : M.classPrefix);
                return (t += e + '">') + n + (a ? "" : T)
            }

            function _() {
                var e, n, a, t, i;
                if (!l.keywords) return x(c);
                for (a = "", l.lexemesRe.lastIndex = e = 0, n = l.lexemesRe.exec(c); n;) a += x(c.substring(e, n.index)), t = l, i = n, i = r.case_insensitive ? i[0].toLowerCase() : i[0], (t = t.keywords.hasOwnProperty(i) && t.keywords[i]) ? (d += t[1], a += s(t[0], x(n[0]))) : a += x(n[0]), e = l.lexemesRe.lastIndex, n = l.lexemesRe.exec(c);
                return a + x(c.substr(e))
            }

            function m() {
                o += (null != l.subLanguage ? function () {
                    var e = "string" == typeof l.subLanguage;
                    if (e && !w[l.subLanguage]) return x(c);
                    var n = e ? C(l.subLanguage, c, !0, N[l.subLanguage]) : R(c, l.subLanguage.length ? l.subLanguage : void 0);
                    return 0 < l.relevance && (d += n.relevance), e && (N[l.subLanguage] = n.top), s(n.language, n.value, !1, !0)
                } : _)(), c = ""
            }

            function b(e) {
                o += e.className ? s(e.className, "", !0) : "", l = Object.create(e, {parent: {value: l}})
            }

            function p(e) {
                var n = e[0], e = e.rule;
                return e && e.endSameAsBegin && (e.endRe = new RegExp(n.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), "m")), e.skip ? c += n : (e.excludeBegin && (c += n), m(), e.returnBegin || e.excludeBegin || (c = n)), b(e), e.returnBegin ? 0 : n.length
            }

            function f(e) {
                var n = e[0], e = t.substr(e.index), a = function e(n, a) {
                    if (t = n.endRe, i = a, (t = t && t.exec(i)) && 0 === t.index) {
                ...
                if (a) {
                    e = l;
                    for (e.skip ? c += n : (e.returnEnd || e.excludeEnd || (c += n), m(), e.excludeEnd && (c = n)); l.className && (o += T), l.skip || l.subLanguage || (d += l.relevance), (l = l.parent) !== a.parent;) ;
                    return a.starts && (a.endSameAsBegin && (a.starts.endRe = a.endRe), b(a.starts)), e.returnEnd ? 0 : n.length
                }
            }
            ...
            function E(e, n) {
                var a = n && n[0];
                if (c += e, null == a) return m(), 0;
                if ("begin" == i.type && "end" == n.type && i.index == n.index && "" === a) return c += t.slice(n.index, n.index + 1), 1;
                if ("illegal" === i.type && "" === a) return c += t.slice(n.index, n.index + 1), 1;
                if ("begin" === (i = n).type) return p(n);
                if ("illegal" === n.type && !g) throw new Error('Illegal lexeme "' + a + '" for mode "' + (l.className || "<unnamed>") + '"');
                if ("end" === n.type) {
                    e = f(n);
                    if (null != e) return e
                }
            ...
            var r = S(n);
            if (!r) throw console.error(k.replace("{}", n)), new Error('Unknown language: "' + n + '"');
            A(r);
            for (var l = u || r, N = {}, o = "", e = l; e !== r; e = e.parent) e.className && (o = s(e.className, "", !0) + o);
            var c = "", d = 0;
            try {
                for (var h, v, y = 0; ;) {
                    if (l.terminators.lastIndex = y, !(h = l.terminators.exec(t))) break;
                    v = E(t.substring(y, h.index), h), y = h.index + v
                }
                for (E(t.substr(y)), e = l; e.parent; e = e.parent) e.className && (o += T);
                return {relevance: d, value: o, illegal: !1, language: n, top: l}
            } catch (e) {
                if (e.message && -1 !== e.message.indexOf("Illegal")) return {illegal: !0, relevance: 0, value: x(t)};
                if (O) return {relevance: 0, value: x(t), language: n, top: l, errorRaised: e};
                throw e
            }
        }
        ...
        function R(a, e) {
            e = e || M.languages || s(w);
            var t = {relevance: 0, value: x(a)}, i = t;
            return e.filter(S).filter(y).forEach(function (e) {
                var n = C(e, a, !1);
        ...
        function N(e) {
            return M.tabReplace || M.useBR ? e.replace(c, function (e, n) {
        ...
        function h(e) {
            var n, a, t, i, s = function (e) {
                var n, a, t, i, s, r = e.className + " ";
                if (r += e.parentNode ? e.parentNode.className : "", a = o.exec(r)) return (s = S(a[1])) || (console.warn(k.replace("{}", a[1])), console.warn("Falling back to no-highlight mode for this block.", e)), s ? a[1] : "no-highlight";
                for (n = 0, t = (r = r.split(/\s+/)).length; n < t; n++) if (_(i = r[n]) || S(i)) return i
            }(e);
            _(s) || (M.useBR ? (a = document.createElement("div")).innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n") : a = e, i = a.textContent, n = s ? C(s, i, !0) : R(i), (a = m(a)).length && ((t = document.createElement("div")).innerHTML = n.value, n.value = b(a, m(t), i)), n.value = N(n.value), e.innerHTML = n.value, e.className = (a = e.className, t = s, i = n.language, t = t ? r[t] : i, i = [a.trim()], a.match(/\bhljs\b/) || i.push("hljs"), -1 === a.indexOf(t) && i.push(t), i.join(" ").trim()), e.result = {
                language: n.language,
                re: n.relevance
            }, n.second_best && (e.second_best = {language: n.second_best.language, re: n.second_best.relevance}))
        }

        function n() {
            var e;
            n.called || (n.called = !0, e = document.querySelectorAll("pre code"), g.forEach.call(e, h))
        }
        ...
        return t.highlight = C, t.highlightAuto = R, t.fixMarkup = N, t.highlightBlock = h, t.configure = function (e) {
            M = i(M, e)
        }, t.initHighlighting = n, t.initHighlightingOnLoad = function () {
            ...
            f(w[n] = a), a.rawDefinition = e.bind(null, t), a.aliases && a.aliases.forEach(function (e) {
                r[e] = n
            })
        }, t.listLanguages = function () {
            return s(w)
        }, t.getLanguage = S, t.requireLanguage = function (e) {
            var n = S(e);
            if (n) return n;
            throw new Error("The '{}' language is required, but not loaded.".replace("{}", e))
        }, t.autoDetection = y, t.inherit = i, t.debugMode = function () {
            O = !1
            ...
            illegal: "\\n",
            contains: [t.BACKSLASH_ESCAPE]
        }, t.PHRASAL_WORDS_MODE = {begin: /\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/}, t.COMMENT = function (e, n, a) {
            e = t.inherit({className: "comment", begin: e, end: n, contains: []}, a || {});
            return e.contains.push(t.PHRASAL_WORDS_MODE), e.contains.push({
                className: "doctag",
    ...
    }, o = "object" == typeof window && window || "object" == typeof self && self, void 0 === c || c.nodeType ? o && (o.hljs = l({}), "function" == typeof define && define.amd && define([], function () {
        return o.hljs
    })) : l(c);
    !function () {
        "use strict";
        c.registerLanguage("asciidoc", e), c.registerLanguage("bash", n), c.registerLanguage("clojure", a), c.registerLanguage("cpp", t), c.registerLanguage("cs", i), c.registerLanguage("css", s), c.registerLanguage("diff", r), c.registerLanguage("dockerfile", d), c.registerLanguage("elixir", g), c.registerLanguage("go", u), c.registerLanguage("groovy", _), c.registerLanguage("haskell", m), c.registerLanguage("java", b), c.registerLanguage("javascript", p), c.registerLanguage("json", f), c.registerLanguage("kotlin", E), c.registerLanguage("lua", N), c.registerLanguage("markdown", h), c.registerLanguage("nix", v), c.registerLanguage("none", y), c.registerLanguage("objectivec", w), c.registerLanguage("perl", O), c.registerLanguage("php", M), c.registerLanguage("properties", x), c.registerLanguage("puppet", C), c.registerLanguage("python", S), c.registerLanguage("ruby", T), c.registerLanguage("rust", k), c.registerLanguage("scala", A), c.registerLanguage("shell", R), c.registerLanguage("sql", D), c.registerLanguage("swift", L), c.registerLanguage("xml", I), c.registerLanguage("yaml", B), [].slice.call(document.querySelectorAll("pre code.hljs[data-lang]")).forEach(function (e) {
            c.highlightBlock(e)
        })
    }()
}();